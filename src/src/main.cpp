...
// 	}
	...
	((sil::function::Int_node*)return_value.get())->set_value(5);
	...
	sil::function::Expression_ptr print_value(new sil::function::String_node);
	((sil::function::String_node*)return_value.get())->set_value("Hello world!");
        ...
        ((sil::function::Call_node*)print_call.get())->set_children(print_parameters);
